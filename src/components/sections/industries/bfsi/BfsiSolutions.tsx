...
const SOLUTIONS = [
  "Talent acquisition for banking & finance roles",
  "Compliance-driven workforce management",
  "Payroll & statutory compliance",
  "Staffing for operations, risk, and support roles",
  "RPO solutions for large-scale hiring",
  "Digital onboarding & workforce tracking"
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h3 className="text-3xl lg:text-4xl font-display font-black uppercase tracking-tight">
            Our BFSI <span className="text-primary">Workforce Solutions</span>
          </h3>
        </div>
