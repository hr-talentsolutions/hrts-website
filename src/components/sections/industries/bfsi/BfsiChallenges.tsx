...
const CHALLENGES = [
  {
    ...
    desc: "Navigating ever-changing statutory requirements and labor laws in the financial sector."
  },
  {
    icon: Users,
    title: "High demand for skilled professionals",
    desc: "Competing for top-tier talent in specialized financial and technical roles."
  },
  {
    icon: Lock,
    title: "Data security & confidentiality",
    desc: "Ensuring workforce handling sensitive financial data adheres to strict security protocols."
  },
  {
    icon: Cpu,
    title: "Rapid digital transformation",
    desc: "Upskilling and hiring for new-age digital banking and fintech roles."
  },
  {
    icon: UserMinus,
    title: "High attrition rates",
    desc: "Implementing retention strategies to maintain workforce stability and institutional knowledge."
  }
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-16">
          ...
          <h3 className="text-3xl lg:text-4xl font-display font-black text-primary uppercase tracking-tight">
            Key Challenges in <span className="text-secondary">BFSI</span>
          </h3>
        </div>
