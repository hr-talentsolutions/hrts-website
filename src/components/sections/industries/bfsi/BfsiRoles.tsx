...
const ROLES = [
  { icon: Briefcase, title: "Relationship Managers" },
  { icon: BarChart4, title: "Financial Analysts" },
  { icon: ShieldCheck, title: "Risk & Compliance Officers" },
  { icon: CreditCard, title: "Loan Processing Executives" },
  { icon: Headset, title: "Customer Support Executives" },
  { icon: Layout, title: "Operations & Back Office Staff" }
];

export const BfsiRoles = () => {
  return (
