...
import { History, ShieldCheck, Users2, Timer, Scaling } from "lucide-react";

const REASONS = [
  { icon: History, title: "Deep Industry Expertise", desc: "Years of experience supporting major institutions in this sector." },
  { icon: ShieldCheck, title: "Compliance Framework", desc: "Rigorous adherence to statutory and regulatory standards." },
  { icon: Users2, title: "Diverse Talent Pool", desc: "Access to a vast network of pre-vetted professionals." },
  { icon: Timer, title: "Faster Turnaround", desc: "Agile recruitment processes to meet urgent business needs." },
  { icon: Scaling, title: "Scalable Solutions", desc: "Flexible staffing that grows with your organization." }
];

export const IndustryWhyChoose = () => {
  return (
