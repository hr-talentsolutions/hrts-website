...
export const IndustryRoles = ({ roles }: IndustryRolesProps) => {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h3 className="text-3xl lg:text-4xl font-display font-black text-primary uppercase tracking-tight">
            Key Roles <span className="text-secondary">We Support</span>
          </h3>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {roles.map((role, i) => (
            ...
            >
              ...
              <h4 className="text-lg font-display font-black text-secondary uppercase tracking-tight">
                {role}
              </h4>
            </motion.div>
          ))}
