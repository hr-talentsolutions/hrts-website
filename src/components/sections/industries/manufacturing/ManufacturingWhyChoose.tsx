...
const REASONS = [
  { icon: Users2, title: "Large-scale workforce deployment", desc: "Expertise in managing and deploying massive workforces seamlessly." },
  { icon: History, title: "Industry-specific hiring expertise", desc: "Deep understanding of manufacturing roles and skill requirements." },
  { icon: ShieldCheck, title: "Compliance-driven processes", desc: "100% statutory adherence to protect your business and reputation." },
  { icon: Zap, title: "Fast turnaround for bulk hiring", desc: "Agile recruitment cycles to meet sudden production demands." },
  { icon: Scaling, title: "Scalable workforce solutions", desc: "Flexible staffing models that cover multiple locations and sites." }
];

export const ManufacturingWhyChoose = () => {
  return (
