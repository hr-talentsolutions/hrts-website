          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            >
              <h2 className="text-2xl lg:text-4xl font-display font-black text-white mb-10 leading-tight tracking-tight uppercase">
                Ready to scale your engineering and product teams?<br />
                <span className="text-primary italic">Hire vetted tech developers today.</span>
              </h2>
