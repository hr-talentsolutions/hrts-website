        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          >
            ...
            <p className="text-lg lg:text-xl text-text-sub font-bold leading-relaxed mb-8 border-l-4 border-primary pl-6 uppercase tracking-tight">
              Power your digital transformation and engineering projects with elite software developers, systems architects, and IT specialists.
            </p>
            
            <div className="space-y-6 text-base text-text-sub font-medium leading-relaxed opacity-90">
              <p>
                In today's fast-paced digital ecosystem, having the right technology team determines your speed-to-market and operational success. At HR Talent Solutions, we specialize in identifying, vetting, and placing top-tier technical professionals who align with your roadmap and culture.
              </p>
              <p>
                We offer flexible, client-centric recruitment models—from permanent placement to contract staffing and managed services. Whether you are building an AI team, migrating to the cloud, or scaling a software development squad, our tech-focused recruitment experts deliver excellence.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="relative z-10 rounded-[40px] overflow-hidden shadow-2xl border-2 border-primary/10 bg-white">
              <Image 
                src="/images/services/tech-staffing.png" 
                alt="Tech Staffing Services" 
                width={800} 
                height={600}
