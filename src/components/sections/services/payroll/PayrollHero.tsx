        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          >
            ...
            <p className="text-lg lg:text-xl text-text-sub font-bold leading-relaxed mb-8 border-l-4 border-primary pl-6 uppercase tracking-tight">
              Payroll Services streamline salary processing, compliance, and employee compensation management.
            </p>
            
            <div className="space-y-6 text-base text-text-sub font-medium leading-relaxed opacity-90">
              <p>
                At HR Talent Solutions, we ensure accurate, timely, and compliant payroll operations, enabling organizations to focus on their core business activities.
              </p>
              <p>
                Our payroll solutions cover the complete employee compensation lifecycle—from validation and processing to disbursement and compliance. With structured workflows and technology-driven systems, we minimize errors, ensure statutory compliance, and enhance employee satisfaction.
              </p>
            </div>
          </motion.div>
