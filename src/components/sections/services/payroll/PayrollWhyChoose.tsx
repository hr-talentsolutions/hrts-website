...
const REASONS = [
  { icon: CheckCircle2, label: "Accurate and error-free payroll processing" },
  { icon: Clock, label: "Timely salary disbursement" },
  { icon: ShieldCheck, label: "Compliance with statutory regulations" },
  { icon: Layout, label: "Reduced administrative burden" },
  { icon: Lock, label: "Secure and confidential data handling" },
  { icon: Scaling, label: "Scalable payroll solutions" }
];

export const PayrollWhyChoose = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h3 className="text-3xl lg:text-4xl font-display font-black text-primary uppercase tracking-tight">
            Why Choose Our <span className="text-secondary">Payroll Solutions</span>
          </h3>
        </div>
