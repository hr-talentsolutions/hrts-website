...
const REASONS = [
  { icon: Gavel, label: "Strong understanding of labor laws and regulations" },
  { icon: ShieldAlert, label: "Reduced compliance risks and penalties" },
  { icon: FileCheck, label: "Accurate documentation and reporting" },
  { icon: Scaling, label: "Scalable compliance frameworks" },
  { icon: Cpu, label: "Technology-enabled compliance tracking" },
  { icon: Search, label: "Reliable and transparent processes" }
];

export const ComplianceWhyChoose = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h3 className="text-3xl lg:text-4xl font-display font-black text-primary uppercase tracking-tight">
            Why Choose Our <span className="text-secondary">Compliance Solutions</span>
          </h3>
        </div>
