        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          >
            ...
            <p className="text-lg lg:text-xl text-text-sub font-bold leading-relaxed mb-8 border-l-4 border-primary pl-6 uppercase tracking-tight">
              Compliance Services ensure that organizations adhere to statutory regulations, labor laws, and governance frameworks while managing their workforce.
            </p>
            
            <div className="space-y-6 text-base text-text-sub font-medium leading-relaxed opacity-90">
              <p>
                At HR Talent Solutions, we provide reliable and structured compliance solutions that minimize risks, ensure transparency, and maintain operational integrity.
              </p>
              <p>
                Our compliance services are designed to handle complex regulatory requirements across industries. From payroll compliance to workforce documentation and statutory filings, we ensure your business operates within legal frameworks while focusing on growth and efficiency.
              </p>
            </div>
          </motion.div>
