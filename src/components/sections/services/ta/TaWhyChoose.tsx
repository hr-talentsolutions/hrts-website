...
const REASONS = [
  { icon: Zap, label: "Faster hiring cycles" },
  { icon: Target, label: "Access to top talent pools" },
  { icon: Briefcase, label: "Industry-specific hiring expertise" },
  { icon: Scaling, label: "Scalable recruitment solutions" },
  { icon: UserSquare2, label: "Strong employer branding support" },
  { icon: BarChart, label: "Data-driven hiring approach" }
];

export const TaWhyChoose = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h3 className="text-3xl lg:text-4xl font-display font-black text-primary uppercase tracking-tight">
            Why Choose Our <span className="text-secondary">Talent Acquisition Services</span>
          </h3>
        </div>
