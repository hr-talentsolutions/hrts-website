        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-text-sub max-w-2xl mx-auto font-medium">
              We provide specialized workforce solutions across a wide range of
              sectors, ensuring compliance, quality, and operational excellence
              in every industry.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {INDUSTRIES_DATA.map((industry, i) => {
              const Icon =
                ICON_MAP[industry.iconName as keyof typeof ICON_MAP];
